...
class DanhMucSanPhamController extends Controller
{
    public function them_danh_muc(){
        return view('qtv.them_danh_muc');
    }
    public function liet_ke_danh_muc(){
        $tat_ca_danh_muc = DB::table('tbl_san_pham')->get();
        $quan_ly_danh_muc = view('qtv.liet_ke_danh_muc')->with('liet_ke_danh_muc',$tat_ca_danh_muc);
        return view('qtv_bo_cuc')->with('qtv.liet_ke_danh_muc',$quan_ly_danh_muc);        
    }
    public function luu_danh_muc(Request $request){
        ...
        DB::table('tbl_san_pham')->insert($data);
