                ...
                <div class="position-center">
                    ...
                    <form role="form" action="{{URL::to('/cap_nhat_danh_muc/'.$gia_tri->ID_THE_LOAI)}}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{$gia_tri->TEN}}" name="ten_danh_muc" class="form-control" id="exampleInputEmail1" placeholder="Tên danh mục">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">Mô tả danh mục</label>
                            <textarea style="resize: none" rows="8" name="mo_ta_danh_muc" class="form-control" id="exampleInputPassword1" placeholder="Mô tả danh mục">{{$gia_tri->MO_TA}}</textarea>
                        </div>
                        <div class="form-group">
